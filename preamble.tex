...
% Рисует рамку
    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(185,286)(5.5,0.7)
                    \linethickness{0.5mm}
                    \put(-0.5, 0){\framebox(184.5,286.25){}}
                    ...
                    \put(20, -0.25){\Box{15}{\gostRamkaFont № докум.}}
                    \put(39.5, 0){\line(0,1){15}}
                    \put(41.5, 0){\Box{10}{\gostRamkaFont Подпись}}
...
\renewcommand{\bibfont}{\fontsize{13pt}{15.6pt}\selectfont}

\captionsetup[figure]{labelsep=space, font={large}}
